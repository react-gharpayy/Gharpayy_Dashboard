...
import { Tour, TourOutcome, WhyLost } from '@/features/tour-module/lib/types';
...
import { intentBg, confirmationLabel } from '@/features/tour-module/lib/confidence';
...
export function TourCard({ tour: t, onUpdate, variant = 'full' }: Props) {
  ...
  return (
    <div className={cn(
      'rounded-xl border bg-surface-2/40 p-3 space-y-2.5 transition-colors',
      t.intent === 'hard' && 'border-role-tcm/30 bg-role-tcm/5',
      t.intent === 'medium' && 'border-role-hr/20',
