...
} from "@/types/tour-module";
import { ACTIVITIES, FOLLOWUPS, LEADS, PROPERTIES, TCMS, TOURS, HANDOFFS, SEQUENCES_INIT } from "@/data/tour-module-mock";
import { autoAssign as autoAssignFn } from "@/lib/tours/routing";
